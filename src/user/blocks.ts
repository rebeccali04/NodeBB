...
function blockFunction(User) {
    User.blocks = {
        ...
        is: function (targetUid:string, uids) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const isBlocked = uids.map((uid, index) => {
        ...
        can: function (callerUid:string, blockerUid:string|number, blockeeUid:number, type) {
            return __awaiter(this, void 0, void 0, function* () {
                // Guests can't block
        ...
        list: function (uids:string[]) {
            return __awaiter(this, void 0, void 0, function* () {
                const isArray = Array.isArray(uids);
                const processedUids = (isArray ? (Array.isArray(uids) ? uids : [uids]) : [uids]);
                // Changed assigned newUids instead of passing it to uids
                const newUids = processedUids.map(uid => parseInt(uid, 10));

                const cachedData = {};
                const unCachedUids = User.blocks._cache.getUnCachedKeys(newUids, cachedData);
        ...
        add: function (targetUid, uid:string) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        remove: function (targetUid, uid:string) {
            return __awaiter(this, void 0, void 0, function* () {
